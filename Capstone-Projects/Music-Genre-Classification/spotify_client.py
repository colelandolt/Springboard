...
class SpotifyAPI(object):
    ...
    def get_resource(self, lookup_id, resource_type='albums', return_tracks=False, version='v1'):
        if (return_tracks):
            tracks = 'top-tracks' if resource_type == 'artists' else 'tracks'
    ...
    def get_album_tracks(self, _id):
        return self.get_resource(_id, resource_type='albums', return_tracks=True)
    
    def get_artist(self, _id):
        return self.get_resource(_id, resource_type='artists')
    
    def get_artist_tracks(self, _id):
        return self.get_resource(_id, resource_type='artists', return_tracks=True)
    
    def get_playlist(self, _id):
        return self.get_resource(_id, resource_type='playlists')
    
    def get_playlist_tracks(self, _id):
        return self.get_resource(_id, resource_type='playlists', return_tracks=True)
    ...
    def search(self, query=None, operator=None, operator_query=None, search_type='track'):
        ...
        query_params = urlencode({"q": query, "type": search_type.lower(), "limit": 50})
